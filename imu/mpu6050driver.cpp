...
void MPU6050Driver::handleInput()
{
  ...
  message.linear_acceleration_covariance[0] = 0.005 * 9.81;
  message.linear_acceleration_covariance[4] = 0.005 * 9.81;
  message.linear_acceleration_covariance[8] = 0.005 * 9.81;
  message.linear_acceleration.x = mpu6050_->getAccelerationX() * 9.81;
  message.linear_acceleration.y = mpu6050_->getAccelerationY() * 9.81;
  message.linear_acceleration.z = mpu6050_->getAccelerationZ() * 9.81;
  message.angular_velocity_covariance[0] = 0.05 * 0.017453;
  message.angular_velocity_covariance[4] = 0.05 * 0.017453;
  message.angular_velocity_covariance[8] = 0.05 * 0.017453;
  message.angular_velocity.x = mpu6050_->getAngularVelocityX() * 0.017453;
  message.angular_velocity.y = mpu6050_->getAngularVelocityY() * 0.017453;
  message.angular_velocity.z = mpu6050_->getAngularVelocityZ() * 0.017453;
