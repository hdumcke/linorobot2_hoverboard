...
#include "linorobot2_hoverboard_hardware/hoverboard_system.hpp"
...
namespace linorobot2_hoverboard_hardware
{
...
hardware_interface::return_type linorobot2_hoverboard_hardware::DiffBotSystemHardware::write(
  const rclcpp::Time & /*time*/, const rclcpp::Duration & /*period*/)
{
  // BEGIN: This part here is for exemplary purposes - Please do not copy to your production code
...
PLUGINLIB_EXPORT_CLASS(
  linorobot2_hoverboard_hardware::DiffBotSystemHardware, hardware_interface::SystemInterface)
